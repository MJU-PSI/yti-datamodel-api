...
public class ImportManager {
    ...
    public void createResourceGraphs(String graph,
        ...
        String query
            ...
            + "WHERE { "
            + " GRAPH ?graph { "
            + " VALUES ?type { rdfs:Class sh:NodeShape owl:DatatypeProperty owl:ObjectProperty owl:AnnotationProperty } "
            + " ?resource a ?type . "
            + " OPTIONAL { "
            + "  ?resource dcterms:subject ?subject . "
            + "  ?subject ?sp ?so . "
    ...
    private void removeDuplicatesFromModel(String graph) {
        ...
        String query
            ...
            + "GRAPH ?graph { "
            + "?graph owl:imports ?import .  "
            + "OPTIONAL { VALUES ?type { rdfs:Class sh:NodeShape owl:DatatypeProperty owl:ObjectProperty owl:AnnotationProperty } "
            + "?resource a ?type . "
            + "?resource ?p ?o . "
